...
namespace Jhipster.Security.Jwt
{
    ...
    {
        private const string AuthoritiesKey = "role";
        ...
        public async Task<string> CreateToken(IPrincipal principal, bool rememberMe)
        {
            ...
            var subject = CreateSubject(principal, id);
            var validity =
        ...
        private static ClaimsIdentity CreateSubject(IPrincipal principal, string UserId)
        {
